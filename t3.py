...
class AudioAnalyzerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Аналізатор аудіо з Ансамблем ШІ (5 Моделей + Суддя)")
    ...
    def get_model_folders(self):
        ...
        # Шукаємо лише директорії всередині training
    ...
    def on_folder_change(self, event):
        ...
        if selected_folder:
            # Завантажуємо нові моделі
            self.load_models_from_folder(selected_folder)

            # Якщо файл вже завантажено, перераховуємо результати новими моделями
            if self.audio_path:
    ...
    def reset_app(self):
        ...
        # Оновлюємо список папок перед поверненням на головний екран
        self.folders = self.get_model_folders()
